...
void choose_50_50(GtkButton*button, gpointer user_data)/*new*/
{
	...
	*/
	...
	else if(0)//(easy->correct_ans[x.easy_index[0]]==1)||(easy->correct_ans[x.easy_index[0]]==2)
	{
...
gboolean show_audience_vote_result(gpointer user_data)/*new*/
{
	DATA*game = user_data;
    gtk_widget_show((GtkWidget*)game->audience_option[0]);
