...
void QUESTIONS()
{
	...
	strcpy(medium.questions[32].string , "The recently signed MoU between Integrated Defence Staff and which organization aims to set up telemedicine nodes for soldiers in high-altitude areas?");
	...
	strcpy(medium.questions[42].string , "Rikako Ikee, who has become the first female athlete to be named the Most Valuable Player (MVP) at Asian Games, is from which country?");
