...
void QUESTIONS()
{
    ...
    strcpy(hard.questions[3].string , "Which national park was named so because the local Maharaja relocated ten villages from the area and declared it a \nhunting preserve?");
    ...
    strcpy(hard.questions[9].string , "On the birth centenary of which ghazal singer did the ministry of culture, government of India issue \ncommemorative coins in 2014?");
